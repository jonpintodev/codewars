...
function passOrFail(harmony) {
  //.map() to iterate through each element in the array and .split() to separate them by the spaces 
  let array = harmony.map(element => element.split(' '))
